...
public class MainTests {
    public static void main(String[] args) {
        ...
        AutoNuova a1 = new AutoNuova(10, Marca.Porsche, "911 GT3 RS", dim911, motore911, descrizione911, 258536, scontoPerMese);
        ...
        AutoNuova ferrari = new AutoNuova(20, Marca.Ferrari, "F8 Tributo", dimFerrari, motoreFerrari, descrizioneFerrari, 280000, scontoPerMeseFerrari);
        ...
        AutoNuova lamborghini = new AutoNuova(30, Marca.Lamborghini, "Aventador SVJ", dimLamborghini, motoreLamborghini, descrizioneLamborghini, 550000, scontoPerMeseLamborghini);
        ...
        AutoNuova audi = new AutoNuova(40, Marca.Audi, "R8 V10 Plus", dimAudi, motoreAudi, descrizioneAudi, 180000, scontoPerMeseAudi);
        ...
        AutoNuova mercedes = new AutoNuova(50, Marca.Mercedes, "AMG GT R", dimMercedes, motoreMercedes, descrizioneMercedes, 190000, scontoPerMeseMercedes);
        ...
        AutoNuova tesla = new AutoNuova(60, Marca.Tesla, "Model S Plaid", dimTesla, motoreTesla, descrizioneTesla, 125000, scontoPerMeseTesla);
        ...
        AutoNuova ford = new AutoNuova(70, Marca.Ford, "Mustang GT", dimFord, motoreFord, descrizioneFord, 55000, scontoPerMeseFord);
